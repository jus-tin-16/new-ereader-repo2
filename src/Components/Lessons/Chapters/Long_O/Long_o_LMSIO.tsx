...
const Long_o_LMSIO = ({setCurrentPage}) => {
    const test = ['1', '2'];
    return (
        <ThemeProvider breakpoints={['xxxl', 'xxl', 'xl', 'lg', 'md', 'sm', 'xs', 'xxs']} minBreakpoint="xxs">
            <Container fluid="sm" style={{padding: '20px'}}>
                ...
                <Row style={{paddingTop: '50px', paddingBottom: '20px'}}>
                    <Col>
                    <Button variant="secondary" style={{}} onClick={() => setCurrentPage("Long_o")} size="lg"> Go Back </Button>
                    </Col>
                </Row>
            </Container>
        </ThemeProvider>
