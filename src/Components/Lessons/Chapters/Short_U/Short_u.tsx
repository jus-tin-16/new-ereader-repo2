                    ...
                    <Col md="auto">
                        <Stack gap={35}>
                            <div className="d-grid gap-2">
                                <Button variant="secondary" onClick={() => setCurrentPage("Short_u_SIOS")} size="lg">Sound it Out Slowly</Button>
                                <Button variant="secondary" onClick={() => setCurrentPage("Short_a_SIOQ")} size="lg" disabled>Sound it Out Quickly</Button>
                                <Button variant="secondary" onClick={() => setCurrentPage("Short_u_LMSIO")} size="lg">Let Me Sound it Out</Button>
